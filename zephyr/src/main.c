/*
 * Myco Mini — firmware Zigbee (add-on R23 / ZBOSS) pour le breakout
 * AN54LQ-15. Port de la version BLE/BTHome (feature/an54lq15-breakout-test)
 * — même hardware, mêmes lectures capteurs, radio 802.15.4/Zigbee au lieu
 * de BLE. Un seul endpoint combinant Temperature, Humidity, Illuminance,
 * Power Config (batterie) et Soil Moisture (cluster custom, cf
 * zb_soil_moisture_defs.h) — pattern repris du projet b-parasite
 * (github.com/rbaron/b-parasite), qui fait un capteur de plante Zigbee
 * quasi identique.
 *
...
/* ── Périphériques (identiques à la version BLE) ───────────────── */
